...
public class UnregisterImageContact {
...
//					String STATUS = pmsccrEle.elementTextTrim("STATUS");
					...
					// Date()));
					reqbody.setDESCRIPTION("Unregister POWER LPAR Image");
					reqbody.setPMSCITEMNUM("PMRDP_0221A_72");// PMRDP_0211A_72P/E2E_ADDSERVER
					reqbody.setCLASSSTRUCTUREID("8100242");//8100242
					...
					reqbody.setITEMNUM("PMRDP_0221A_72");// PMRDP_0211A_72
