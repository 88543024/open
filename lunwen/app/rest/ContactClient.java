...
public class ContactClient {
	...
	public static void addProject(String memory,String os,String dbsoft,String middleware,String disksize,String vcpu,Integer workOrderId,String projectName,String imageId,String serverNum,Long id,String segment){
...
//					String STATUS = pmsccrEle.elementTextTrim("STATUS");
					...
					// Date()));
					reqbody.setDESCRIPTION("Add server with POWER LPAR Servers ");
					reqbody.setPMSCITEMNUM("PMRDP_0212A_72");// PMRDP_0211A_72P/E2E_ADDSERVER
					reqbody.setCLASSSTRUCTUREID("8100222");//8100211
					...
					reqbody.setITEMNUM("PMRDP_0212A_72");// PMRDP_0211A_72
...
//						attr.setVAL("100");// 硬盘容量
						...
						attr.setValType("TABLE");
						attr.setVAL(op.getImageId());//镜像11839/12638/12898/12880
						ticList.add(attr);
					}else if (assetAttrId != null
						...
						ticList.add(attr);
							...
							&& "PMRDPCLSWS_SWIDS".equals(assetAttrId)) {
						attr.setASSETATTRID("PMRDPCLSWS_SWIDS");
						attr.setValType("ALN");
						ticList.add(attr);
					}else if (assetAttrId != null
						...
						attr.setValType("TABLE");
						attr.setVAL("ADDSERVER");// ADDSERVER/Create Project
													// with POWER
						// LPAR Servers
						ticList.add(attr);
					}else if (assetAttrId != null
						...
						attr.setValType("TABLE");
						attr.setVAL("NOTIFYPENDINGDELETE");// NITIFYPENDINGDELETE/NOTIFYPENDINGDELETEPR
						ticList.add(attr);
					}else if (assetAttrId != null
							&& "PMRDPCLVSRV_DELETE_MPNUM".equals(assetAttrId)) {
						attr.setASSETATTRID("PMRDPCLVSRV_DELETE_MPNUM");
						attr.setValType("TABLE");
						attr.setVAL("DELSERVER");// DELSERVER
						ticList.add(attr);
					}else if (assetAttrId != null
						...
						ticList.add(attr);
							...
							&& "PMRDPCLCVS_RESGRPNAME".equals(assetAttrId)) {
						attr.setASSETATTRID("PMRDPCLCVS_RESGRPNAME");
						attr.setValType("ALN");
						ticList.add(attr);
					}else if (assetAttrId != null
