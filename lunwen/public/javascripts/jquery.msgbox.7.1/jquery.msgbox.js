...
(function($) {
	...
	$.msgbox = function(opts) {
		...
		//this.contentWrapWrap = $('<div />').appendTo(this.mainWrap).addClass('jMsgbox-contentWrapWrap');
		//this.contentWrapWrap.css({'display': 'block', 'width': this.opts.width + 'px','height': (this.opts.height - 24) + 'px','overflow': 'auto' });
		this.contentWrap = $('<div />').appendTo(this.contentWrapWrap).html(this.opts.content).addClass('jMsgbox-contentWrap');
		//alert(this.contentWrap.html);
		...
		domready: function(){
			...
			switch(this.opts.type){
				...
				case 'confirm':
					...
					var yesbutton = $('<input type="button" value="是" />').click(function(){
						_this.setValue( true );
						_this.close();	
					});
					var nobutton = $('<input type="button" value="否" />').click(function(){
					...
					_this.extend('show', function(self){
						self.apply(this, arguments);
						//_this.contentWrapWrap.height(this.opts.height - this.headWrap.outerHeight(true) - center.outerHeight(true));
						_this.contentWrapWrap.height(40);
					});
					break;
				case 'input':
					_this.contentWrapWrap.height(parseInt(_this.contentWrapWrap.css('height'))-40);
