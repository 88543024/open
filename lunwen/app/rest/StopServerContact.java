...
public class StopServerContact {
...
//					String STATUS = pmsccrEle.elementTextTrim("STATUS");
					...
					// Date()));
					reqbody.setDESCRIPTION("Stop Servers ");
					reqbody.setPMSCITEMNUM("PMRDP_0256A_72");// PMRDP_0211A_72P/E2E_ADDSERVER
					reqbody.setCLASSSTRUCTUREID("8100232");//8100211
					...
					reqbody.setITEMNUM("PMRDP_0256A_72");// PMRDP_0211A_72
			...
			if (obj != null) {
				...
				for (int i = 0; i < ticketSpecList.size(); i++) {
					...
					if (assetAttrId != null
						...
						attr.setValType("TABLE");
						attr.setVAL("STOPSRV");// 用于预留资源的资源组
						ticList.add(attr);
					}else if (assetAttrId != null
						...
						ticList.add(attr);
							...
							&& "PMRDPOPTYPE".equals(assetAttrId)) {
						attr.setASSETATTRID("PMRDPOPTYPE");
						attr.setValType("ALN");
						attr.setVAL("POWEROFF"); 
						ticList.add(attr);
					}
				}
