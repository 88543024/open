...
public class RemoveServerContact {
	...
	public static void modifyServer(String id){
...
//	
		...
		StepThreeReqBody Step3req = jxStepTwoGetStepThreeParam(jsonContent,id);
...
//			form.add("CLASSIFICATIONID", "PMRDP_SR_SERVEROP");
...
//					String STATUS = pmsccrEle.elementTextTrim("STATUS");
					...
					// Date()));
					reqbody.setDESCRIPTION("Remove Servers ");
					reqbody.setPMSCITEMNUM("PMRDP_0253A_72");// PMRDP_0211A_72P/E2E_ADDSERVER
					reqbody.setCLASSSTRUCTUREID("8100234");//8100211
					...
					reqbody.setITEMNUM("PMRDP_0253A_72");// PMRDP_0211A_72
...
//					param.setSRCATTRVAL("Management Segment");
	...
	public static StepThreeReqBody jxStepTwoGetStepThreeParam(String jsonContent,String id) {
				...
				for (int i = 0; i < ticketSpecList.size(); i++) {
					...
					if (assetAttrId != null
						...
						ticList.add(attr);
							...
							&& "PMRDPCLCPR_KEEP_EXISTING_IMAGES_ON_EXIT".equals(assetAttrId)) {
						attr.setASSETATTRID("PMRDPCLCPR_KEEP_EXISTING_IMAGES_ON_EXIT");
						attr.setValType("ALN");
						attr.setVAL("false"); 
						ticList.add(attr);
					}else if (assetAttrId != null
							&& "PMRDPCLCPR_SAVE_IMAGES_ON_EXIT".equals(assetAttrId)) {
